...
for (const f of ['market-summary.json','bond-market.json','stocks.json','companies.json','currency-data.json','news.json','market-close.json','sens.json','calendar.json','commodities.json']) {
